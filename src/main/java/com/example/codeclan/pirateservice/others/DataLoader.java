package com.example.codeclan.pirateservice.others;
...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        Signup signup1 = new Signup(jack, raid1);
        signUpRepository.save(signup1);

        Signup signup2 = new Signup(jack, raid2);
        signUpRepository.save(signup2);

        Signup signup3 = new Signup(bart, raid1);
        signUpRepository.save(signup3);

        Signup signup4 = new Signup(william, raid3);
        signUpRepository.save(signup4);

        Signup signup5 = new Signup(maggie, raid4);
